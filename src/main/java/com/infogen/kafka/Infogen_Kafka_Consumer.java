...
import com.infogen.event_handle.Logger_Consume_Handle;
 ...
 */
public class Infogen_Kafka_Consumer {
	public final Logger logger = Logger.getLogger(InfoGen_Jetty.class.getName());

	public static void consume(InfoGen_Configuration infogen_configuration, String group, String topic, Logger_Consume_Handle handle) {
