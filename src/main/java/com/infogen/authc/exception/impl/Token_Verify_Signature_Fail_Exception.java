 ...
 * @version 1.0
 */
public class Token_Verify_Signature_Fail_Exception extends InfoGen_Auth_Exception {
	private static final long serialVersionUID = -4016175431541270378L;
	...
	public Integer code() {
		...
		return Auth_Exception_CODE.token_verify_signature_fail.code;
	}
	...
	public String name() {
		// TODO Auto-generated method stub
		return Auth_Exception_CODE.token_verify_signature_fail.name();
	}
	...
	public String note() {
		// TODO Auto-generated method stub
		return Auth_Exception_CODE.token_verify_signature_fail.note;
	}
